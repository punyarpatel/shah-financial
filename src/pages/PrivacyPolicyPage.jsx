            ...
            <FadeIn>
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc pl-5 space-y-2 text-muted text-[14.5px] leading-relaxed">
                  ...
                  <li>Facilitate the processing of investment instructions (buying, selling, switching schemes) via digital platforms.</li>
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc pl-5 space-y-2 text-muted text-[14.5px] leading-relaxed mb-4">
                  ...
                  <li><strong>Platform Partners:</strong> Sharing transactions via backend systems.</li>
